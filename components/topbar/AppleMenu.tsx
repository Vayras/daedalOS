...
export default function AppleMenu({
  ...
  return (
    <div ref={ref} className="fixed top-10 text-black bg-gray-200 opacity-95 border-2 border-gray-950 rounded-lg shadow-md shadow-black/25 dark:shadow-black/25 left-2 w-56 " >
      <MenuItemGroup>
